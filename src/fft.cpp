...
//typedef struct { double re ; double im ; } complex ; //lmartins: not needed and can create name clashing!
...
void fft::bitreverse(double x[], int N) {
	double rtemp, itemp;
	int i, j, m;
 ...
 */
void fft::rfft(double x[], int N, int forward) {
...
void fft::cfft(double x[], int NC, int forward) {
	 ...
	 * scale output
	 */
	scale = forward ? (double) 1.0 / ND : (double) 2.0;
	{
